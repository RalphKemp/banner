...
TweenMax.to("#dollar", 4, {bezier:{type:"soft", values:[{x:200, y:50}, {x:300, y:30}, {x:600, y:70}], autoRotate:true}, ease:Sine.easeInOut});
TweenMax.to("#euro", 4, {bezier:{type:"soft", values:[{x:100, y:50}, {x:200, y:-100}, {x:600, y:-120}], autoRotate:true}, ease:Sine.easeInOut});
TweenMax.to("#pound", 4, {bezier:{type:"soft", values:[{x:100, y:50}, {x:300, y:0}, {x:600, y:120}], autoRotate:true}, ease:Sine.easeInOut});
